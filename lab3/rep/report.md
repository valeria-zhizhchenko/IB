...
![Информация о пользователях](../image/03.png){ #fig:003 width=70% }
...
![Содержимое файла /etc/group и регистрация в группе](../image/04.png){ #fig:004 width=70% }
...
![Изменение прав у директории](../image/05.png){ #fig:005 width=70% }
